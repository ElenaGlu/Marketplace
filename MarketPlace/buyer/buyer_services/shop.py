...
class Shop:
    ...
    @staticmethod
    def selects_products_by_category(catalog: Dict[str, int]) -> list:
        """
    ...
    @staticmethod
    def detail_product(product: Dict[str, int]) -> list:
        """
        Detailed information about the product.
        :param product: dict containing key - id
    ...
    @staticmethod
    def add_cart(profile, data: Dict[str, int]) -> None:
        """
    ...
    @staticmethod
    def change_cart(profile, data: Dict[str, int]) -> None:
        """
    ...
    @staticmethod
    def remove_cart(profile, data: Dict[str, int]) -> None:
        """
